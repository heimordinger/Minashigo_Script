...
from script_spec.draft_store import DRAFT_AUTOSAVE_MS, DRAFT_DIR
from script_spec.mixin_draft import DraftMixin
...
class SpecEditor(DraftMixin, QWidget):
    """隔离的说明编辑器。"""
    ...
    def _build_ui(self):
        ...
        self._draft_chip.setToolTip(str(DRAFT_DIR))
    ...
    def _on_edited(self, *_):
        ...
        self._draft_timer.start(DRAFT_AUTOSAVE_MS)
