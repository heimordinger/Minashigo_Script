...
export async function loadAllNodes(){
    ...
    await import("../nodes/flow/compare.js?t=" + Date.now());
    await import("../nodes/flow/cond_goto.js?t=" + Date.now());
    await import("../nodes/flow/confirm.js?t=" + Date.now());
    await import("../nodes/flow/logic_gates.js?t=" + Date.now());
    await import("../nodes/flow/math_op.js?t=" + Date.now());
    await import("../nodes/flow/sub_workflow.js?t=" + Date.now());
    await import("../nodes/flow/update_frame.js?t=" + Date.now());
    await import("../nodes/flow/variable.js?t=" + Date.now());
    await import("../nodes/flow/variable_access.js?t=" + Date.now());
